  ...
  return (
    <section className="relative overflow-hidden px-8 pb-24 pt-28 md:pt-36">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-32 left-1/2 h-[600px] w-[700px] -translate-x-1/2 rounded-full bg-azure/10 blur-[120px]" />
        <div className="absolute -top-10 right-0 h-[400px] w-[400px] rounded-full bg-blue-400/10 blur-[100px] dark:bg-blue-500/15" />
        <div className="bg-azure/8 absolute bottom-0 left-0 h-[350px] w-[350px] rounded-full blur-[100px]" />
      </div>
      <div className="mx-auto max-w-5xl text-center">
        ...
        >
          <a
            href="#calendly"
            className="inline-flex items-center justify-center gap-2 rounded-full bg-ink px-7 py-3.5 font-mono text-sm font-medium text-paper transition-all duration-200 hover:bg-azure"
          >
            Book an intro call ↗
          </a>
          <a
