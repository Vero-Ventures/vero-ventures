    ...
    >
      <div className="mx-auto mt-10 max-w-3xl">
        ...
        <p className="my-4 text-center text-muted-foreground">
          ...
          creation, and technology consulting to help businesses innovate, grow,
      ...
      <div className="grid grid-cols-1 gap-7 px-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        <ServiceCard>
          ...
          <ServiceHeader>Web and Mobile Application Development</ServiceHeader>
          <ServiceDescription>
        ...
        <ServiceCard>
          ...
          <ServiceDescription>
            Expert guidance on digital transformation, technology adoption, and
            aligning your IT strategy with business goals. We help you make
            informed decisions that optimize efficiency and innovation.
          </ServiceDescription>
        </ServiceCard>
      </div>
    </section>
